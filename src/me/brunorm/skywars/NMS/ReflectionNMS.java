...
public class ReflectionNMS implements NMS {
	...
	public Class<?> getChatSerializer() {
		try {
			Bukkit.getConsoleSender().sendMessage(Messager.color(this.prefix + "&6Loading &cold &bChatSerializer"));
			return this.getNMS("ChatSerializer");
		} catch (final Exception e) {
			try {
				Bukkit.getConsoleSender().sendMessage(Messager.color(this.prefix + "&6Loading &anew &bChatSerializer"));
				return this.getNMS("IChatBaseComponent$ChatSerializer");
			} catch (final Exception e2) {
				Bukkit.getConsoleSender()
						.sendMessage(Messager.color(this.prefix + "&cCould not load &bChatSerializer"));
				return null;
			}
		}
	}
	...
	public Class<?> getIChatBaseComponent() {
		try {
			Bukkit.getConsoleSender()
					.sendMessage(Messager.color(this.prefix + "&6Loading &bChatBaseComponent Interface"));
			return this.getNMS("IChatBaseComponent");
		} catch (final Exception e) {
			Bukkit.getConsoleSender()
					.sendMessage(Messager.color(this.prefix + "&cCould not load &bChatBaseComponent Interface"));
			return null;
		}
	}
	...
	public Class<?> getPacketPlayOutTitle() {
		try {
			Bukkit.getConsoleSender().sendMessage(Messager.color(this.prefix + "&6Loading &bPacketPlayOutTitle"));
			return this.getNMS("PacketPlayOutTitle");
		} catch (final Exception e) {
			Bukkit.getConsoleSender()
					.sendMessage(Messager.color(this.prefix + "&cCould not load &bPacketPlayOutTitle"));
			return null;
		}
	}
	...
	public Class<?> getPacketPlayOutChat() {
		try {
			Bukkit.getConsoleSender().sendMessage(Messager.color(this.prefix + "&6Loading &bPacketPlayOutChat"));
			return this.getNMS("PacketPlayOutChat");
		} catch (final Exception e) {
			Bukkit.getConsoleSender().sendMessage(Messager.color(this.prefix + "&cCould not load &bPacketPlayOutChat"));
			return null;
		}
	}
	...
	public Class<?> getEnumTitleAction() {
		try {
			Bukkit.getConsoleSender().sendMessage(Messager.color(this.prefix + "&6Loading &cold &bEnumTitleAction"));
			return this.getNMS("EnumTitleAction");
		} catch (final Exception e) {
			try {
				Bukkit.getConsoleSender()
						.sendMessage(Messager.color(this.prefix + "&6Loading &anew &bEnumTitleAction"));
				return this.getNMS("PacketPlayOutTitle$EnumTitleAction");
			} catch (final Exception e2) {
				Bukkit.getConsoleSender()
						.sendMessage(Messager.color(this.prefix + "&cCould not load &bEnumTitleAction"));
				return null;
			}
		}
	}
	...
	public Class<?> getChatMessageTypeClass() {
		try {
			Bukkit.getConsoleSender().sendMessage(Messager.color(this.prefix + "&6Loading &bChatMessageType"));
			return this.getNMS("ChatMessageType");
		} catch (final Exception e) {
			Bukkit.getConsoleSender().sendMessage(Messager.color(this.prefix + "&cCould not find &bChatMessageType"));
			return null;
		}
	}
